import { lerp, r2, TAU } from "./math.ts";
import { PROFILE_SAMPLES, type ProfileName, PROFILES } from "./profiles.ts";
...
export function blend(
  ...
  const dst = out ??
    { radii: new Array<number>(PROFILE_SAMPLES), rot: 0, cx: 0, cy: 0, sx: 1, sy: 1 };
