...
const BALANCE_SIDEBAR_SETTINGS_NAMESPACE = "balance-sidebar";
/** Settings section schema: what the web settings surface edits. */
const BALANCE_SIDEBAR_SETTINGS_SCHEMA = z.object({
...
function apply(ctx, config = {}) {
	...
	installSettingsSection(ctx, settingsNamespace(BALANCE_SIDEBAR_SETTINGS_NAMESPACE), BALANCE_SIDEBAR_SETTINGS_SCHEMA, base, {
		setSource: (source) => {
			current = source;
		},
		onChange: () => {
...
//#endregion
export { BALANCE_SIDEBAR_API_PREFIX, BALANCE_SIDEBAR_SETTINGS_NAMESPACE, BALANCE_SIDEBAR_SETTINGS_SCHEMA, BalanceSidebarService, DEFAULT_API_KEY_ENV, DEFAULT_BASE_URL, DEFAULT_COST_CONFIG, DEFAULT_REFRESH_INTERVAL_SECONDS, FLASH_COST_CONFIG, PRICING_URL, PRO_COST_CONFIG, ZERO_TOKENS, aggregateWorkspaces, apply, costOfTokens, costOfUsage, fetchPricing, inject, isPeakHour, makeBalanceRoutes, name, resolveCostConfig, sumTokens, totalOf, ungroupedSessionIds };
