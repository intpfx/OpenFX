/**
 * dsh-balance-sidebar locale dictionaries (zh/en).
 * @module dsh-balance-sidebar/client/locales
 */
/** Dictionary namespace this package registers. */
export declare const NS = "balanceSidebar";
/** Chinese copy. */
...
export type BalanceSidebarKey = keyof typeof zh;
