 ...
 */
export declare function buildCostMap(sessions: readonly SessionRowLike[], summary: BalanceSidebarSummary | undefined): Map<string, number>;
...
export type BalanceWorkspaceWidgetProps = PropsRuntime<"sidebar.footer.action"> & PropsLocale<typeof NS>;
/** The footer widget component. */
export declare function BalanceWorkspaceWidget(props: BalanceWorkspaceWidgetProps): JSX.Element;
export {};
//# sourceMappingURL=BalanceWorkspaceWidget.d.ts.map