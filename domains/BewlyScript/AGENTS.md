...
Keep `hls.js` and `flv.js`; they support video playback behavior. Keep `qrcode.vue` and `vuedraggable`; they support the settings login QR code and drag-and-drop settings ordering.
