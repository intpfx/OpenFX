...
export declare const USAGE_BALANCE_SETTINGS_NAMESPACE = "usage-balance";
/** Settings section schema: what the web settings surface edits. */
export declare const USAGE_BALANCE_SETTINGS_SCHEMA: z<Schemastery.ObjectS<{
...
export declare const name = "usage-balance";
