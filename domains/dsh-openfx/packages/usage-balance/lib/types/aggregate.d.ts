/**
 * dsh-usage-balance workspace aggregation — pure token/cost math shared by
 ...
 * @module dsh-usage-balance/aggregate
 */
...
export declare function sumTokens(a: WorkspaceTokens, b: WorkspaceTokens): WorkspaceTokens;
...
export declare function ungroupedSessionIds(allSessionIds: readonly string[], workspaces: readonly {
    sessionIds: readonly string[];
}[], archivedSessionIds: readonly string[]): string[];
 ...
 */
export declare function aggregateWorkspaces(workspaces: readonly {
    id: string;
    title: string;
    sessionIds: readonly string[];
}[], ungroupedIds: readonly string[], opts: AggregateOptions): WorkspaceAggregate[];
